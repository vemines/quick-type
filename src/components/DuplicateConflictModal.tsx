      ...
      >
        ...
        <div className="px-6 py-4 border-b border-slate-200 dark:border-slate-700/80 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-md bg-amber-50 dark:bg-[#0c1220] border border-amber-200 dark:border-amber-500/50 flex items-center justify-center text-amber-600 dark:text-amber-400">
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="space-y-3">
            {/* Existing Active */}
            <div className="p-3.5 rounded-md bg-emerald-50/80 dark:bg-[#0c1220] border border-emerald-300 dark:border-emerald-500/50 space-y-1.5 shadow-xs">
              ...
              <div className="text-xs font-mono text-slate-900 dark:text-slate-100 bg-white dark:bg-[#121927] p-2.5 rounded-md border border-emerald-200 dark:border-emerald-800/60 line-clamp-2">
                {existing.content}
              </div>
            </div>

            {/* Candidate Trigger */}
            <div className="p-3.5 rounded-md bg-amber-50/80 dark:bg-[#0c1220] border border-amber-300 dark:border-amber-500/50 space-y-1.5 shadow-xs">
              <div className="flex items-center justify-between">
              ...
              <div className="text-xs font-mono text-slate-900 dark:text-slate-100 bg-white dark:bg-[#121927] p-2.5 rounded-md border border-amber-200 dark:border-amber-800/60 line-clamp-2">
                {candidate.content}
              </div>
            </div>
          </div>
          ...
          <div className="pt-2 flex items-center justify-end gap-2">
            <button
              type="button"
              onClick={dismissDuplicateConflict}
              className="px-3.5 py-2 text-xs sm:text-sm font-medium rounded-md text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors cursor-pointer"
            >
            ...
            <button
              ...
              className="px-3.5 py-2 text-xs sm:text-sm font-semibold rounded-md bg-amber-600 hover:bg-amber-500 active:bg-amber-700 text-white shadow-sm shadow-amber-600/20 transition-all cursor-pointer"
            >
